...
public class CreateMarkerActivity extends AppCompatActivity
   ...
   // private SharedPreferences mSharedPreferences;
    ...
    public void addGeofencesButtonHandler(View view) {
      ...
      //float lon =  mSharedPreferences.getFloat("lon", 1);
        ...
        Intent lauchMainActivity = new Intent(CreateMarkerActivity.this, MainActivity.class);
        startActivity(lauchMainActivity);
    }
